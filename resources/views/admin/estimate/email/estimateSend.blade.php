...
<table cellpadding="0" cellspacing="0" border="0" width="700" style="border:1px solid #d5d5d5; font-family:'dotum'; font-size:12px">
    ...
    <tr>
        <td style='border-top:2px solid #0095eb;'>
            ...
            <a href="https://4science.net/shop/goods?ca01=29&ca02=4182&ca03=4199&ca04=4202" target='_blank'>
                <img src="{{ asset('storage/event/2025/0512/estimate.jpg') }}" />
            </a>
        </td>
    </tr>
    ...
    <tr>
        <td style='border-top:2px solid #0095eb;'>
            <a href="https://4science.net/shop/goods?ca01=36&ca02=8077" target='_blank'>
                <img src="{{ asset('storage/event/2025/0421/estimate.jpg') }}" />
            </a>
