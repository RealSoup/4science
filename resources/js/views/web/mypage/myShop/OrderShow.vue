...
.container .goods { margin-top:2rem; }
.container .goods .container { margin-bottom:1rem; }
.container .goods .container>b { font-size:2rem; }
.container .goods .container .row { border-bottom:1px solid #DDD; margin-bottom:1rem; padding-bottom:1rem;  }
.container .goods .container .row>div { align-items:center; justify-content:center; display:flex; }
.container .goods .container .row>div img { width:160px; height:160px; object-fit:cover; }
.container .goods .container .row>div:nth-child(2) .btn { text-align:left; }
.container .goods .container .row>div:nth-child(3) { justify-content:end; text-align:right; }
.container .goods .container .row>div:nth-child(3) svg { margin:0 10px; }
.container .goods .container .row>div:nth-child(3) .md_multi { display:inline-block; min-width:90px; }

.container .price .row div { text-align:right; }
.container .price .row div b { display:inline-block; min-width:200px; }

.container .orderer .row .col .row div:first-child { font-weight:bold; }
