    ...
    <div id="core" class="layout">
        ...
        <nav>
            <div class="nav_left">
                ...
                <b-link class="m_hide" :to="{name: 'search_test'}">검색 테스트</b-link>
                <b-link class="m_hide" :to="{name: 'search_test', query: {ca01:30}}">1차(클린룸)</b-link>
            </div>
...
#header #core nav .nav_left { line-height: 15px; }
#header #core nav .nav_left a { font-size:14px; font-weight:700; padding:0 10px; }
#header #core nav .nav_left a:first-child { 
...
#header #core nav .nav_right form { position:relative; display:flex; width:55%; border-radius:12px; margin-right:8px 20px 0;
...
#header #core nav .nav_right form input { border:0; background:transparent; font-size:14px; }
...
#header #core nav .nav_right a img { width:35px; height:35px; }
#header #core nav .nav_right a p { margin:0; font-size:12px; font-weight:600; letter-spacing:-1px; }
#header #core nav .nav_right .cart { position: relative; }
#header #core nav .nav_right .cart b { background-color:#02ABEC; color:#fff; border-radius:14px; padding:3px 6px; font-size:12px; position:absolute; top:-5px; right:0; }

#header .bottom_menu { display:none; }

@media (max-width: 992px){
    #header { border-bottom:0; padding:0; }
    #header #core { text-align:center; }
    #header #core .logo { width:200px; margin-top:1em; padding:0; transform:none; }
    #header #core .logo img {  max-width:170px; width:auto; height:auto; }
    #header #core nav { align-items:center; margin:12px 0; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); }
    #header #core nav>div { display:flex; align-items: center; }
    #header #core nav .nav_left #cate_btn { display:inline-block; background-image:none; background-color:#666; padding:0; }
    #header #core nav .nav_left #cate_btn img { display:inline-block; max-width:34px; }
    #header #core nav .nav_left #cate_btn span { display:none; }



    #header #core nav .nav_right { max-width:0; }
    #header #core nav .nav_right form { width:85%; max-width:85%; position:absolute; top:0; z-index:17; left:50%; transform:translateX(-50%); max-height:0; transition:max-height .2s; overflow:hidden; background: #FFF; border-width:0; }
    #header #core nav .nav_right form.view_sch { max-height:50px; border-width:1px; } 
    
    
    #header #core nav .nav_right a:not(:last-child) { display:none; }
    ...
    #header .bottom_menu a { width:100%; height:100%; flex-basis:0; flex-grow:1; max-width:100%; text-align:center; font-size:12px; padding:10px; line-height:13px; }
