...
.frm_st .link .login { padding:.65rem; width:100%; }
.frm_st .link.link_auth { border-bottom:2px solid #C2C2C2; padding:1.5rem 0; margin:0;}
.frm_st .link.link_auth a { color:#898989; font-size:.8rem; display:inline-block; padding:0; cursor:pointer; }
...
.frm_st .link:last-child .col { text-align:center; margin-top:1.5rem; }
