...
<div>
    ...
    <div class="recommend">
        ...
        <b-container class="layout">
            ...
            <b-row>
                <b-col col cols="12" md="12" lg="6"><b-link to="/shop/makerShop/577"><b-img :src="`${s3url}main/rec001.png`" /></b-link></b-col>
            ...
            <b-row>
                ...
                <b-col col cols="6" md="6" lg="3"><b-link :to="{name:'goods_show', params:{gd_id:14}}"><b-img :src="`${s3url}main/rec006.png`" /></b-link></b-col>
