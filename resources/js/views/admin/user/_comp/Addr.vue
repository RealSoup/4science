...
.p_wrap .row .col:nth-child(5) { flex:0 0 60%; max-width:60%; }
.p_wrap .row .col:nth-child(6) { flex:0 0 40%; max-width:40%; }
.p_wrap .row .col:nth-child(7) { flex:0 0 100%; max-width:100%; padding-bottom:.5rem; }
