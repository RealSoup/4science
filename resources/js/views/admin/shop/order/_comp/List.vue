...
<div id="order_list">
    ...
    <b-row class="body" :class="{cancel:row.od_step==60, don_t:(row.user && row.user.group==3), introducer:(row.user.introducer)}" v-for="row in list" :key="row.mk_id">
...
#order_list .introducer { background:#44ADF1; }
