    ...
    <b-container>
        ...
        <b-container v-for="(em, mi) in value" :key="mi" class="gd_list">
            ...
            <b-row>
                ...
                <b-col class="type02">
                    <b-form-input :id="'estimate_model.'+mi+'.em_name'" v-model="em.em_name" required />
            ...
            <b-row class="mb-3">
                ...
                <b-col class="type01">
                    <EaInput v-model="em.em_ea" :id="'estimate_model.'+mi+'.em_ea'" :em="em" @calculator="calculator" />
                ...
                <b-col class="type01">
                    <PriceInput v-model="em.em_price" :id="'estimate_model.'+mi+'.em_price'" @calculator="calculator" />
