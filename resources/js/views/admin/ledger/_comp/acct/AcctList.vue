...
<b-container fluid>
    ...
    <b-row class="search">
        <b-col class="seq"></b-col>
        <b-col v-if="mode!=='pay_tx'" class="ctrl"></b-col>
        <b-col v-if="mode!=='pay_od'" class="pay_t">
            <b-form-select v-model="sch.pay_type" size="sm" @change="index">
                <b-form-select-option value=""></b-form-select-option>
                <b-form-select-option v-for="(v, k) in config.pay_type" :key="k" :value="k">{{ v }}</b-form-select-option>
            </b-form-select>
        </b-col>
        <b-col class="mng">
            <b-form-select v-model="sch.mng" size="sm" @change="index">
                <b-form-select-option value=""></b-form-select-option>
                <b-form-select-option v-for="(v, k) in mng" :key="k" :value="v.name">{{ v.name }}</b-form-select-option>
            </b-form-select>
        </b-col>
        <b-col class="odno"><SearchInput v-model="sch.od_id" @index="index" /></b-col>
        <b-col class="pdt"><SearchInput v-model="sch.lga_date" @index="index" /></b-col>
        <b-col class="dist"><SearchInput v-model="sch.distributor" @index="index" /></b-col>
        <b-col class="depart"><SearchInput v-model="sch.depart" @index="index" /></b-col>
        <b-col class="oder"><SearchInput v-model="sch.orderer" @index="index" /></b-col>
        <b-col class="odnm"><SearchInput v-model="sch.od_name" @index="index" /></b-col>
        <b-col class="eap"><SearchInput v-model="sch.ea_p" @index="index" /></b-col>
        <b-col class="txp"><SearchInput v-model="sch.surtax" @index="index" /></b-col>
        <b-col class="sump"><SearchInput v-model="sch.sum_p" @index="index" /></b-col>
        <b-col v-if="mode=='soon'"><SearchInput v-model="sch.ref_soon" @index="index" /></b-col>
        <b-col v-if="mode=='soon'"><SearchInput v-model="sch.memo_soon" @index="index" /></b-col>
        <b-col v-if="mode=='pay_od'"><SearchInput v-model="sch.ref_pay_od" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="nopay">
            <b-form-select v-model="sch.no_pay" size="sm" @change="index">
                <b-form-select-option v-for="(v, k) in config.no_pay" :key="k" :value="k">{{ v }}</b-form-select-option>
            </b-form-select>
        </b-col>
        <b-col v-if="mode=='pay_tx'" class="cadt"><SearchInput v-model="sch.card_pay_date" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="atdt"><SearchInput v-model="sch.after_pay_date" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="mail"><SearchInput v-model="sch.email" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="tel"><SearchInput v-model="sch.tel" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="tcom"><SearchInput v-model="sch.tax_com" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="tmng"><SearchInput v-model="sch.tax_mng" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="ccod"><SearchInput v-model="sch.client_code" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="kind">
            <b-form-select v-model="sch.kind" size="sm" @change="index">
                <b-form-select-option v-for="(v, k) in config.kind" :key="k" :value="k">{{ v }}</b-form-select-option>
            </b-form-select>
        </b-col>
        <b-col v-if="mode=='pay_tx'" class="cacom">
            <b-form-select v-model="sch.card_com" size="sm" @change="index">
                <b-form-select-option v-for="(v, k) in config.card_com" :key="k" :value="k">{{ v }}</b-form-select-option>
            </b-form-select>
        </b-col>
        <b-col v-if="mode=='pay_tx'" class="apno"><SearchInput v-model="sch.appd_no" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'" class="payer"><SearchInput v-model="sch.payer" @index="index" /></b-col>
        <b-col v-if="mode=='pay_tx'"><SearchInput v-model="sch.memo_pay_tx" @index="index" /></b-col>
    </b-row>
...
<!-- <br/>
            ...
            <b-col v-if="mode!=='pay_od'" class="pay_t">
                <b-form-select v-model="lga.lga_pay_type" size="sm" @change="lga.is_edit=true">
                    <b-form-select-option v-for="(v, k) in config.pay_type" :key="k" :value="k">{{ v }}</b-form-select-option>
                </b-form-select>
            </b-col>
            ...
            <b-col class="nopay" v-if="mode=='pay_tx'">
                <b-form-select v-model="lga.lga_no_pay" size="sm" @change="lga.is_edit=true">
                    <b-form-select-option v-for="(v, k) in config.no_pay" :key="k" :value="k">{{ v }}</b-form-select-option>
                </b-form-select>
            </b-col>
            ...
            <b-col v-if="mode=='pay_tx'" class="kind">
                <b-form-select v-model="lga.lga_kind" size="sm" @change="lga.is_edit=true">
                    <b-form-select-option v-for="(v, k) in config.kind" :key="k" :value="k">{{ v }}</b-form-select-option>
                </b-form-select>
            </b-col>
            <b-col v-if="mode=='pay_tx'" class="cacom">
                <b-form-select v-model="lga.lga_card_com" size="sm" @change="lga.is_edit=true">
                    <b-form-select-option v-for="(v, k) in config.card_com" :key="k" :value="k">{{ v }}</b-form-select-option>
                </b-form-select>
            </b-col>
...
.container-fluid .body .col .hidden_menu { position:absolute; left:0; }
