...
aside { background-color:#4E647B; padding-top:10px; display:flex; flex:0 0 170px; max-width:170px; flex-direction:column; position:sticky; left:0; top:0; align-self:flex-start; z-index:1021; height:100vh; }
...
.sm_view { display:none; position:fixed; bottom:0; width:100%; z-index:100; background:#FFF; justify-content:flex-end; }
.sm_view>* { border-radius:12px; border-bottom-right-radius:0; border-bottom-left-radius:0; flex:0 0 33%; max-width:33%; }
.sm_view>*:not(:last-child) { border-top-right-radius:0; }
.sm_view>*:not(:first-child) { border-top-left-radius:0; }
