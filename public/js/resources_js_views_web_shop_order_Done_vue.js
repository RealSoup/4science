  ...
  return _c(
    ...
    [
      ...
      _c("ul", [
        ...
        _vm._v(" "),
        _c("li", { staticClass: "dd_style" }, [
          _c("span", [_vm._v("결제 금액")]),
          _c("span", [
            _vm._v(
              _vm._s(_vm._f("won")(_vm._f("comma")(_vm.order.od_all_price)))
            ),
          ]),
        ]),
        _vm._v(" "),
