        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _this.rec_goods_list_type = res.data && res.data.rec_goods_list_type || 'normal';
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_c("b-card", [_vm._v("\r\n                                구매자 및 사용자는 ㈜아이넥서스의 이용약관 및 전자상거래 약관을 확인하였으며 이에 동의합니다. 수입제품의 경우 반품이 불가할 수 있으며, 시약의 경우 연구의 목적으로만 사용이 가능함을 확인합니다.\r\n                                이를 어길 경우에 발생하는 모든 책임은 구매자 및 사용자에 있음을 확인합니다.\r\n                            ")])], 1)], 1)], 1), _vm._v(" "), _vm.rec_goods_list_order.length ? _c("b-row", {
    staticClass: "area_piece suggest sug01"
  }, [_c("b-col", [_vm.rec_goods_list_type == "normal" ? _c("b", [_vm._v("주문하셨던 제품 중 더 필요하신건 없으신가요?")]) : _vm.rec_goods_list_type == "no_history" ? _c("b", [_vm._v("이런 제품은 어떠세요?")]) : _vm._e()]), _vm._v(" "), _vm._l(_vm.rec_goods_list_order, function (gd, i) {
    return _c("b-col", {
      key: i
    }, [_c("b-link", {
      attrs: {
    ...
    staticClass: "area_piece suggest sug02"
