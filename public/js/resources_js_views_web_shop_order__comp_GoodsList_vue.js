...
var render = function render() {
  ...
  return _c("div", [_vm._l(_vm.value, function (pa, pa_id) {
    ...
    staticClass: "total"
  }, [_c("b-row", [_c("b-col", [_vm._v("상품금액")]), _vm._v(" "), _c("b-col", [_c("b", [_vm._v(_vm._s(_vm._f("comma")(_vm.price.goods_add_vat)))]), _vm._v(" 원")])], 1), _vm._v(" "), _c("b-row", [_c("b-col", [_vm._v("배송료")]), _vm._v(" "), _c("b-col", [_c("b", [_vm._v(_vm._s(_vm._f("comma")(_vm.price.air_add_vat + _vm.price.dlvy_add_vat)))]), _vm._v(" 원")])], 1), _vm._v(" "), _c("b-row", [_c("b-col", [_vm._v("결제예정금액")]), _vm._v(" "), _c("b-col", [_c("b", [_vm._v(_vm._s(_vm._f("comma")(_vm.price.total)))]), _vm._v(" 원")])], 1)], 1)], 2);
};
var staticRenderFns = [];
