...
var render = function render() {
  ...
  return _c("div", [_c("b-row", {
    staticClass: "head m_hide"
  }, [_c("b-col", [_vm._v("요청번호")]), _vm._v(" "), _c("b-col", [_vm._v("요청내용")]), _vm._v(" "), _c("b-col", [_vm._v("요청자")]), _vm._v(" "), _c("b-col", [_vm._v("요청일")]), _vm._v(" "), _c("b-col", [_vm._v("진행현황")]), _vm._v(" "), _c("b-col", [_vm._v("담당자")]), _vm._v(" "), _c("b-col", {
    staticClass: "er_box"
    ...
    }, [_vm._v(_vm._s(_vm.mng_off[row.user.mng].name))]) : _vm._e()], 1)]), _vm._v(" "), _c("b-col", [_vm._v(_vm._s(_vm._f("formatDate")(row.created_at)))]), _vm._v(" "), _c("b-col", [row.eq_step === "DONOT" ? _c("b-badge", {
      staticClass: "plum"
    }, [_vm._v(_vm._s(_vm._f("eqStep")(row.eq_step)))]) : row.eq_step === "DOING" ? _c("b-badge", {
      staticClass: "mint"
    }, [_vm._v(_vm._s(_vm._f("eqStep")(row.eq_step)))]) : row.eq_step === "DONE" ? _c("b-badge", {
      staticClass: "gray"
    }, [_vm._v(_vm._s(_vm._f("eqStep")(row.eq_step)))]) : row.eq_step === "CANCEL" ? _c("b-badge", {
      staticClass: "yellow"
    }, [_vm._v(_vm._s(_vm._f("eqStep")(row.eq_step)))]) : _vm._e()], 1), _vm._v(" "), _c("b-col", [row.eq_mng_nm ? _c("span", [_vm._v(_vm._s(row.eq_mng_nm))]) : _vm._e()]), _vm._v(" "), _c("b-col", {
      staticClass: "er_box"
    }, [row.estimate_reply.length == 0 ? [_c("span"), _vm._v(" "), _c("b-link", {
