...
var render = function render() {
  ...
  return _c("div", [_c("b-row", {
    ...
    }, [_vm.mng_off[row.eq_mng_id] ? [_vm._v(_vm._s(_vm.mng_off[row.eq_mng_id].name))] : [_vm._v(_vm._s(row.eq_mng_id))]], 2) : _vm._e()]), _vm._v(" "), _c("b-col", [_vm._v(_vm._s(_vm._f("formatDate")(row.created_at)))]), _vm._v(" "), _c("b-col", {
      staticClass: "d-none d-lg-block"
