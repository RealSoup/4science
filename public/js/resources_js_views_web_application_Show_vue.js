...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("div", {
    ...
    })])])]) : tab.type === "analysis" ? _c("div", {
      staticClass: "section-analysis"
    }, [_c("h3", {
      staticClass: "analysis-title"
    }, [_vm._v(_vm._s(tab.title))]), _vm._v(" "), _c("div", {
      staticClass: "analysis-tabs"
    }, _vm._l(tab.subTabs, function (sub, si) {
      return _c("button", {
        key: si,
        staticClass: "analysis-tab-btn",
        "class": {
          active: _vm.activeSubTab === si
        },
        on: {
          click: function click($event) {
            _vm.activeSubTab = si;
      ...
      staticClass: "analysis-list"
    }, _vm._l(tab.subTabs[_vm.activeSubTab].items, function (item, i) {
      return _c("li", {
        key: i,
        staticClass: "analysis-item"
      }, [_c("span", {
        staticClass: "analysis-num"
      }, [_vm._v(_vm._s(String(i + 1).padStart(2, "0")))]), _vm._v(" "), item.image ? _c("img", {
        staticClass: "analysis-thumb",
        attrs: {
          src: item.image,
          alt: item.title
        }
      }) : _vm._e(), _vm._v(" "), _c("div", {
        staticClass: "analysis-info"
      }, [_c("span", {
        staticClass: "analysis-date"
      }, [_vm._v(_vm._s(item.date))]), _vm._v(" "), _c("strong", {
        staticClass: "analysis-item-title"
      }, [_vm._v(_vm._s(item.title))])])]);
    }), 0), _vm._v(" "), _vm._m(1, true)]) : tab.type === "basic" ? _c("div", {
