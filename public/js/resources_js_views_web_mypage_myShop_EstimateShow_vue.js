...
var render = function render() {
  ...
  return _c("b-container", {
    ...
    staticClass: "top"
  }, [_vm.estimate.eq_step == "DONOT" || _vm.estimate.eq_step == "DOING" ? _c("span", [_vm._v("담당자가 견적 요청을 확인 중 입니다.")]) : _vm._e(), _vm._v(" "), _vm.estimate.eq_step == "DONE" ? _c("span", [_vm._v("견적이 완료 되었습니다.")]) : _vm._e(), _vm._v(" "), _vm.estimate.eq_step == "CANCEL" ? _c("span", [_vm._v("견적 요청이 취소 되었습니다.")]) : _vm._e(), _vm._v(" "), _c("div", _vm._l(_vm.estimate.estimate_reply, function (er, i) {
    return _c("b-button", {
      key: i,
      "class": {
        mint: i == Object.keys(_vm.estimate.estimate_reply).length - 1,
        white: i != Object.keys(_vm.estimate.estimate_reply).length - 1
      },
      attrs: {
        to: {
    ...
    }, [i !== 0 ? [_vm._v("재")] : _vm._e(), _vm._v("견적서 보기 \r\n                    "), _c("br"), _vm._v(" "), _c("small", [_vm._v(_vm._s(_vm._f("formatDate_YYYY_MM_DD")(er.created_at)))])], 2);
